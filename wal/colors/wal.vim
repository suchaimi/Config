...
hi CursorLine term=bold cterm=bold ctermbg=4 ctermfg=0
...
hi Visual ctermbg=0 ctermfg=3 cterm=reverse term=reverse
...
hi MoreMsg ctermbg=NONE ctermfg=7
...
hi CocInfoSign  ctermfg=7 ctermbg=8
hi CocHintSign  ctermfg=7 ctermbg=8
hi CocErrorSign  ctermfg=7 ctermbg=8
hi CocWarningSign  ctermfg=7 ctermbg=8
hi HighlightedyankRegion ctermbg=0 ctermfg=3
